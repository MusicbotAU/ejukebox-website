...
title: Plans & Pricing for Venue Music
description: Solo from $49/mo for a single-area shop, Core from $169/mo for a venue, or Complete with every add-on included. Pick only the features you want.
