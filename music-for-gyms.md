...
benefits:
  - icon: fa-dumbbell
    ...
    text: High-energy, professionally curated playlists that keep the tempo up through every session.
  - icon: fa-clock
  ...
  - icon: fa-certificate
    ...
    text: Personal streaming apps are not licensed for gyms. eJukebox includes your OneMusic licence so you train legally.
---
